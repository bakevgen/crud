...
<body>
	<div class="container">
		<div class="row">
			<div class="col mt-1">
				<?=$success ?>
				<button class="btn btn-success mb-1" data-toggle="modal" data-target="#Modal"><i class="fa fa-book"></i></button>
	    ...
	    <div class="modal-content shadow">
	      ...
	      <div class="modal-body">
	        <form action="" method="post">
	        	...
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="year" value="" placeholder="Год издания">
	        	</div>
	      </div>
