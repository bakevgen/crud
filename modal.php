      ...
      <div class="modal-body">
        <form action="?id=<?=$value['id'] ?>" method="post">
        	<div class="form-group">
        		<input type="text" class="form-control" name="edit_name" value="<?=$value['name'] ?>" placeholder="Название">
        	</div>
        	<div class="form-group">
        		<input type="text" class="form-control" name="edit_author" value="<?=$value['author'] ?>" placeholder="Автор">
        	</div>
        	<div class="form-group">
        		<input type="text" class="form-control" name="edit_year" value="<?=$value['year'] ?>" placeholder="Год издания">
        	</div>
